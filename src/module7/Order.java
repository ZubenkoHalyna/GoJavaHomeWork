...
public class Order {
    ...
    private static OrderComparator byItemAndShopAndCityComparator = new OrderComparator(
            (Order o1, Order o2) -> (o1.user.getCity().equals(o2.user.getCity())) ?
                    (o1.shopIdentificator.equals(o2.shopIdentificator)) ?
                            o1.itemName.compareToIgnoreCase(o2.itemName) :
                            o1.shopIdentificator.compareTo(o2.shopIdentificator) :
    ...
    public static OrderComparator getByItemAndShopAndCityComparator() {
        return byItemAndShopAndCityComparator;
    }
