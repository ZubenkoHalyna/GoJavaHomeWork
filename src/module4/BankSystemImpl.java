...
public class BankSystemImpl implements BankSystem {
    ...
    public Transaction transferMoney(User fromUser, User toUser, int amount){
        ...
        Transaction t = new Transaction(!isAllowed,TransactionType.TRANSFERRING,fromUser,toUser,amount,fromUserBalanceBuf,toUserBalanceBuf,fromUser.getBalance(),toUser.getBalance());
